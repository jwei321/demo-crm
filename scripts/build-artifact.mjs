...
function ctaHTML(){
  return '<section class="sec"><div class="cta"><h2>Questions about <em>your</em> situation?</h2><p class="lead" style="max-width:520px;margin:14px auto 22px">The tools above are a starting point. Message me on Telegram and I can map them to your goals, existing holdings, CPF and risk tolerance.</p><a class="bookbtn" target="_blank" rel="noopener" href="https://t.me/D_TJW"><svg width="16" height="16" viewBox="0 0 24 24" fill="#0A0E1A" aria-hidden="true"><path d="M21.9 4.3 18.6 20c-.24 1.09-.9 1.36-1.82.85l-5.02-3.7-2.42 2.33c-.27.27-.5.5-1 .5l.35-5.07L18.9 5.6c.4-.36-.09-.56-.62-.2L6.9 12.6l-4.97-1.56c-1.08-.34-1.1-1.08.23-1.6L20.5 2.7c.9-.33 1.68.2 1.4 1.6Z"/></svg>Book a review on Telegram</a><div class="disc" style="max-width:620px;margin:26px auto 0">This site is for educational purposes only and does not constitute financial advice, a recommendation, or an offer to buy or sell any product. Market data is illustrative and/or delayed and refreshes weekly. Investments can fall as well as rise; past performance is not indicative of future results. Fund names are the property of AIA; figures shown here are illustrative — always verify against official sources before acting.</div><div class="mono" style="font-size:10px;color:'+MUTED+';margin-top:14px;opacity:.7">'+esc(DATA.meta.stamp)+'</div></div></section>';
}
